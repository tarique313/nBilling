...
<script type="text/javascript">
 $(function(){
	 if(localStorage['email'] && localStorage['flag'] == 1){
	 	$("#email_field").val(localStorage['email']) ;

	 	$("#phone_1").val(localStorage['phone_1']) ;
	 	$("#phone_2").val(localStorage['phone_2']) ;
	 	$("#phone_3").val(localStorage['phone_3']) ;

	 	$("#address_1").val(localStorage['address_1']) ;
	 	$("#address_2").val(localStorage['address_2']) ;
	 	$("#city").val(localStorage['city']) ;
	 	$("#state").val(localStorage['state']) ;
	 	$("#zip").val(localStorage['zip']) ;
	 	
	 	localStorage['email'] = null;
	 	localStorage['phone_1'] = null;
	 	localStorage['phone_2'] = null;
	 	localStorage['phone_3'] = null;
	 	localStorage['address_1'] = null;
	 	localStorage['address_2'] = null;
	 	localStorage['city'] = null;
	 	localStorage['state'] = null;
	 	localStorage['zip'] = null;
	 	localStorage['flag'] = 0;
