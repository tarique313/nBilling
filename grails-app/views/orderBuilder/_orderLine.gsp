    ...
    <li id="line-${index}-editor" class="editor ${editable ? 'open' : ''}">
        <div class="box">
            <div class="form-columns">
				...
				<g:applyLayout name="form/input">
					<content tag="label"><g:message code="order.label.tax"/></content>
					<g:textField name="state_tax" class="field" value="${tax}"/>
					
				</g:applyLayout>
                <p style="margin-left: 158px;"><a href="http://en.wikipedia.org/wiki/Sales_taxes_in_the_United_States" target="_blank">Sales tax reference</a></p>
