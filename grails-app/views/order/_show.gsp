...
<div class="column-hold">
    ...
    <div class="box">
        <table class="dataTable">
            <tr>
                <td colspan="2">
                    ...
                    <em>${user?.contact?.stateProvince}</em>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td><td></td>
        ...
        <table class="dataTable">
            ...
            <tr>
            <td><g:message code="order.label.active.since"/>:</td>
                <td class="value">
            ...
            <td><g:message code="order.label.active.until"/>:</td>
                <td class="value">
             ...
             <%--<tr>
            <td><g:message code="order.label.create.date"/>:</td>
                <td class="value">
                    <g:formatDate date="${order?.dueDateValue}" formatName="date.pretty.format"/>
                </td>
            </tr>
           ...
           <%-- <tr>
            <td><g:message code="order.label.next.invoice"/>:</td>
                <td class="value">
