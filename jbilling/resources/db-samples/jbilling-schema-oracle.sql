...
-- breadcrumb
-----------------------------------------------------------------------------
DROP TABLE breadcrumb CASCADE CONSTRAINTS;
...
(
    id NUMBER(10,0) NOT NULL,
    filter_set_id NUMBER(10,0) NOT NULL,
    ...
    boolean_value BIT,
    decimal_value NUMBER(22,10),
    decimal_high_value NUMBER(22,10),
    version NUMBER(10,0) NOT NULL
);

ALTER TABLE filter
    ADD CONSTRAINT filter_PK
PRIMARY KEY (id);
...
-- filter_set
-----------------------------------------------------------------------------
DROP TABLE filter_set CASCADE CONSTRAINTS;
...
-----------------------------------------------------------------------------
DROP TABLE item_type_exclude_map CASCADE CONSTRAINTS;
...
-----------------------------------------------------------------------------
DROP TABLE notification_category CASCADE CONSTRAINTS;
...
ALTER TABLE notification_category
    ADD CONSTRAINT notification_category_PK
PRIMARY KEY (id);
...
-- recent_item
-----------------------------------------------------------------------------
DROP TABLE recent_item CASCADE CONSTRAINTS;
...
ALTER TABLE report_parameter
    ADD CONSTRAINT report_parameter_PK
PRIMARY KEY (id);
...
-- entity_report_map
-----------------------------------------------------------------------------
DROP TABLE entity_report_map CASCADE CONSTRAINTS;
...
ALTER TABLE entity_report_map
    ADD CONSTRAINT entity_report_map_PK
...
(
    id NUMBER(10,0) NOT NULL,
    mediation_record_id NUMBER(10,0) NOT NULL,
...
-- shortcut
-----------------------------------------------------------------------------
DROP TABLE shortcut CASCADE CONSTRAINTS;
