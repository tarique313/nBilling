     ...
     select reftables.name tablename, cons.name constraintname
      from sysobjects tables,
       ...
       where tables.id = ref.rkeyid
         and cons.id = ref.constid
         and reftables.id = ref.fkeyid
         and tables.name = 'item_type_exclude_map'
     OPEN refcursor
     ...
     select reftables.name tablename, cons.name constraintname
      from sysobjects tables,
       ...
       where tables.id = ref.rkeyid
         and cons.id = ref.constid
         and reftables.id = ref.fkeyid
         and tables.name = 'notification_category'
     OPEN refcursor
     ...
     select reftables.name tablename, cons.name constraintname
      from sysobjects tables,
       ...
       where tables.id = ref.rkeyid
         and cons.id = ref.constid
         and reftables.id = ref.fkeyid
         and tables.name = 'report_parameter'
     OPEN refcursor
     ...
     select reftables.name tablename, cons.name constraintname
      from sysobjects tables,
       ...
       where tables.id = ref.rkeyid
         and cons.id = ref.constid
         and reftables.id = ref.fkeyid
         and tables.name = 'entity_report_map'
     OPEN refcursor
