...
ALTER TABLE entity_report_map
    ADD PRIMARY KEY (report_id,entity_id);
...
-----------------------------------------------------------------------------
-- item_type_exclude_map: FOREIGN KEYS
-----------------------------------------------------------------------------
ALTER TABLE item_type_exclude_map
    ADD CONSTRAINT item_type_exc_FK_1 FOREIGN KEY (item_id)
    REFERENCES item (id)
;
ALTER TABLE item_type_exclude_map
    ADD CONSTRAINT item_type_exc_FK_2 FOREIGN KEY (type_id)
    REFERENCES item_type (id)
;
...
-----------------------------------------------------------------------------
ALTER TABLE notification_message_type
    ADD CONSTRAINT notification__FK_1 FOREIGN KEY (category_id)
    REFERENCES notification_category (id)
;


-----------------------------------------------------------------------------
-- notification_category: FOREIGN KEYS
-----------------------------------------------------------------------------
...
-----------------------------------------------------------------------------
-- report_parameter: FOREIGN KEYS
-----------------------------------------------------------------------------
ALTER TABLE report_parameter
    ADD CONSTRAINT report_parame_FK_1 FOREIGN KEY (report_id)
    REFERENCES report (id)
;


-----------------------------------------------------------------------------
-- entity_report_map: FOREIGN KEYS
-----------------------------------------------------------------------------
ALTER TABLE entity_report_map
    ADD CONSTRAINT entity_report_FK_1 FOREIGN KEY (report_id)
    REFERENCES report (id)
;
ALTER TABLE entity_report_map
    ADD CONSTRAINT entity_report_FK_2 FOREIGN KEY (entity_id)
    REFERENCES entity (id)
;
