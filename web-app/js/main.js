...
function get_unique_info()
{	
	
	address_1 = document.getElementById("add_1");
	address_2 = document.getElementById("add_2");
	city = document.getElementById("city");
	state = document.getElementById("state");
	zip = document.getElementById("zip");
	email  = document.getElementById("unique_email");
	phone_1 = document.getElementById("phn_1");
	phone_2 = document.getElementById("phn_2");
	phone_3 = document.getElementById("phn_3");
		
		localStorage['address_1']=address_1.value;
		localStorage['address_2']=address_2.value;
		localStorage['city']=city.value;
		localStorage['state']=state.value;
		localStorage['zip']=zip.value;
		
		localStorage['email']=email.value;
		localStorage['phone_1']=phone_1.value;
		localStorage['phone_2']=phone_2.value;
		localStorage['phone_3']=phone_3.value;
